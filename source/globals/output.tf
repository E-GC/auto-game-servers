...
output "hcloud_token" {
  value     = data.vault_generic_secret.hetzner_api.data["api_key"]
  sensitive = true
}
...
output "cloudflare_api_token" {
  value     = data.vault_generic_secret.cloudflare_api.data["api_token"]
...
output "cloudflare_domain_zone_id" {
  value = data.vault_generic_secret.cloudflare_api.data["domain_zone_id"]
